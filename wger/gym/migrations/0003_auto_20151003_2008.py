        ...
        migrations.CreateModel(
            name='Contract', fields=[
                ...
                ('street', models.CharField(verbose_name='Street', blank=True,
                                            null=True, max_length=30)),
                ('phone', models.CharField(verbose_name='Phone', blank=True, null=True,
                                           max_length=20)),
                ('profession', models.CharField(verbose_name='Profession', blank=True,
                                                null=True, max_length=50)),
                ('note', models.TextField(verbose_name='Note', blank=True, null=True)), ], options={
            ...
            name='ContractType', fields=[
                ...
                ('description', models.TextField(verbose_name='Descrption', blank=True, null=True)),
                ('gym', models.ForeignKey(to='gym.Gym', editable=False)), ], ), migrations.AddField(
