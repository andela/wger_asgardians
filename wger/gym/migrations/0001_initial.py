    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email', models.EmailField(max_length=75, null=True, verbose_name='Email',
                                            blank=True)),
                ('owner', models.CharField(max_length=100, null=True, verbose_name='Owner',
                                           blank=True)),
                ('zip_code', models.IntegerField(max_length=5, null=True, verbose_name='ZIP code',
                                                 blank=True)),
            ...
            fields=[
                ...
                ('weeks_inactive',
                 models.PositiveIntegerField(default=4,
                                             help_text='Number of weeks since the last time'
                                             ' a user logged his presence tobe considered inactive',
                                             max_length=2,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('include_inactive',
                 models.BooleanField(default=True,
                                     help_text='Include user in the email list of inactive members',
