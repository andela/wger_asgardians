...
class EmailReminderTestCase(WorkoutManagerTestCase):
    ...
    def test_reminder_last_notification(self):
        """Test that no emails are sent if the last notification field is more recent than one week.
    ...
    def test_reminder_last_notification_2(self):
        """Test that no emails are sent if the last notification field is more than one week away.
