...
class WorkoutICalExportTestCase(WorkoutManagerTestCase):
    ...
    def export_ical_token(self):
        """Define Helper function that checks exporing an ical file using tokens for access."""
    ...
    def export_ical_token_wrong(self):
        """Define Helper function that checks exporing an ical file using a wrong token."""
        uid = 'AB'
