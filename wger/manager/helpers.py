...
def reps_smart_text(settings, set_obj):
    u"""Smart textual representation.
    ...
    def get_reps_reprentation(setting, rep_unit):
        """Return the representation for the repetitions for a setting.

        This is basically just to allow for a special representation for
        the "Until Failure" unit
    ...
    def get_weight_unit_reprentation(setting):
        """Return the representation for the weight unit for a setting.

        This is basically just to allow for a special representation for
        the "Repetition" and "Until Failure" unit
    ...
    def normalize_weight(setting):
        ...
        The weight can be None, or a decimal.

        In that case, normalize so that we don't return e.g. '15.00',
        but always '15', independently of the database used.
...
class WorkoutCalendar(HTMLCalendar):
    ...
    * http://uggedal.com/journal/creating-a-flexible-monthly-calendar-in-django/
    ...
    def formatmonth(self, year, month):
        ...
        This is basically the same code from python's calendar module
        but with additional bootstrap classes
