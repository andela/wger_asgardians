        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.CharField(
                    help_text='Ususally a description about what parts are trained,'
                    ' like "Arms" or "Pull Day"', max_length=100, verbose_name='Description')),
            ...
            fields=[
                ...
                ('is_active',
                 models.BooleanField(default=True,
                                     help_text='Tick the box if you want to'
                                     ' mark this schedule as your active one (will be shown'
                                     ' e.g. on your dashboard). All other schedules will then'
                                     ' be marked as inactive', verbose_name='Schedule active')),
                ('is_loop', models.BooleanField(default=False,
                                                help_text='Tick the box if you want to'
                                                ' repeat the schedules in a loop'
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('impression',
                 models.CharField(
                     default=b'2',
                     help_text='Your impression about this workout session. Did you exercise'
