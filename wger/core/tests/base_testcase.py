...
def get_reverse(url, kwargs={}):
    """Its a Helper function to get the reverse URL."""
    try:
...
def get_user_list(users):
    """Its a Helper function that returns a list with users to test."""
...
def delete_testcase_add_methods(cls):
    """Its a Helper function that dynamically adds test methods.
...
class BaseTestCase(object):
    ...
    Generic base testcase that is used for both the regular tests and
    the REST API tests
...
class WorkoutManagerTestCase(BaseTestCase, TestCase):
    ...
    def post_test_hook(self):
        """Hooks to add specific tests after the basic add or delete operations are finished."""
        pass


class WorkoutManagerDeleteTestCase(WorkoutManagerTestCase):
    """Tests deleting an object an authorized user, a different one and a logged out one.

    This assumes the delete action is only triggered with a POST request
    and GET will only show a confirmation dialog.
    ...
    def delete_object(self, fail=False):
        """Its aHelper function to test deleting a workout."""
...
class WorkoutManagerEditTestCase(WorkoutManagerTestCase):
    """Tests editing an object as an authorized user, a different one and a logged out one."""
    ...
    def edit_object(self, fail=False):
        """Its a Helper function to test editing an object."""
        # Only perform the checks on derived classes
...
class WorkoutManagerAddTestCase(WorkoutManagerTestCase):
    """Tests adding an object as an authorized user, a different one and a logged out one."""
    ...
    def add_object(self, fail=False):
        """Its a Helper function to test adding an object."""
        # Only perform the checks on derived classes
...
class WorkoutManagerAccessTestCase(WorkoutManagerTestCase):
    """Tests accessing a URL per GET as an authorized user, an unauthorized and a logged out one."""
